...
def parse_args():
    ...
    parser.add_argument('--early_stopping_patience', type=int, default=15, help='') 
    ...
    parser.add_argument('--g_rate', type=float, default=0.00001, help='ssl_s_rate')
    ...
    parser.add_argument('--loadModelPath', default='/public/home/zhaol/sjzhu20224227061/Codes/newMMSSL/Model/retailrocket/for_meta_hidden_dim_dim__8_retailrocket_2021_07_10__18_35_32_lr_0.0003_reg_0.01_batch_size_1024_gnn_layer_[16,16,16].pth', type=str, help='loadModelPath')
    parser.add_argument('--title', default="try_to_draw_line", type=str, help='')  #


    #train
    parser.add_argument('--data_path', nargs='?', default='/public/home/zhaol/sjzhu20224227061/Codes/newMMSSL/data/', help='Input data path.')
    parser.add_argument('--seed', type=int, default=2024, help='Random seed')
    parser.add_argument('--dataset', nargs='?', default='book', help='Choose a dataset from {sports, baby, clothing, tiktok, allrecipes}')
    ...
    parser.add_argument('--topk', type=int, default=5, help='K value of k-NN sparsification')  
    ...
    parser.add_argument('--cl_rate', type=float, default=0.01, help='Control the effect of the contrastive auxiliary task')        
    ...
    parser.add_argument('--noise', default=1.5, type=float, help='noise scale')  #
    parser.add_argument('--use_AL', default=True, type=float, help='')  #
    parser.add_argument('--use_CL', default=True, type=float, help='')  #
    ...
    parser.add_argument('--id_cat_rate', type=float, default=0.35, help='before GNNs')
    parser.add_argument('--id_cat_rate1', type=float, default=0.35, help='id_cat_rate')
    ...
    parser.add_argument('--G_rate', default=1e-06, type=float, help='for D model1')  #
    parser.add_argument('--G_drop1', default=0.3, type=float, help='for D model2')  #
    parser.add_argument('--G_drop2', default=0.5, type=float, help='')  #
    parser.add_argument('--gp_rate', default=10, type=float, help='gradient penal')  #
